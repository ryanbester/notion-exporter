...
public static class Languages
{
    ...
    public static CultureInfo Locale { get; private set; } = CultureInfo.DefaultThreadCurrentCulture!;
    ...
    public static void SetCulture()
    {
        ...
        try
        {
            ...
            IsRightToLeft = SettingsManager.Settings.Language.ToLower() == "qps-plocm" ||
